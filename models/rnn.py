...
class SpamRNN(nn.Module):
    def __init__(self, vocab_size, embed_size=128, hidden_size=256, num_layers=2, dropout=0.3, num_classes=2):
        super().__init__()
...
class SpamLSTM(nn.Module):
    ...
    def __init__(self, vocab_size, embed_dim=128, hidden_size=256, num_layers=2, dropout=0.3, num_classes=2):
        super().__init__()
    ...
    def forward(self, x):
        ...
        # [out 설명]
        # - out: LSTM의 모든 타입스템(시퀀스 위치) 에서의 은닉 상태(Hidden State) 출력값.
